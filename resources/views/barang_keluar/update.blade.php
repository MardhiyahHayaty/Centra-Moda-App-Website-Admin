            ...
            <div class="modal-body">
                <form id="formData_edit" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="pegawai-edit" required>
                           @foreach($pegawais as $pegawai)
                            <option selected="selected"  value="{{$pegawai->id}}">{{$pegawai->nama_pegawai}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="barang-edit" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tgl_keluar-edit">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="jml_brg_keluar-edit">
