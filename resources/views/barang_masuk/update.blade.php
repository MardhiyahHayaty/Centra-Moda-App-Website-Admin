            ...
            <div class="modal-body">
                <form id="formData_edit" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="supplier-edit" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="admin-edit" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tgl_masuk-edit">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="jml_brg_masuk-edit">
